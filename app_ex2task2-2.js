...
bot.dialog('/', [
 ...
 builder.Prompts.choice(session, 'Where do you want to go to?',
['Brussels', 'Antwerp', 'Ghent']);
 ...
 session.userData.departureTime =
builder.EntityRecognizer.resolveTime([results.response]);
 session.send('Thanks for travelling with us from ' +
session.userData.departure + ' to ' + session.userData.arrival + '!');
 }
]);
bot.dialog('/profile', [
 function (session) {
